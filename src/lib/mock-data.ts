...
function uispYearSeries(
  ...
  target: number,
  actual: number,
  real2025: { baseline: number; target: number; actual: number },
  currentYear = CURRENT_YEAR
) {
  return UISP_YEARS.map((year) => {
    if (year === currentYear) {
      // uisp.vercel.app 실데이터 기준 — 2026년은 실제로 아직 실적 미입력(전 항목 actual=0)
      return { year, baseline, target, actual, status: "입력가능" as YearStatus };
    }
    return {
      year,
      baseline: real2025.baseline,
      target: real2025.target,
      actual: real2025.actual,
...
/**
 * 영역별 평균 달성도 — uisp.vercel.app/api/dashboard 실데이터 그대로 (2026-07-16 확인).
 * 2025는 마감된 확정 실적, 2026은 현재 진행연도인데 실제로 아직 전 항목 미입력 상태라 0%.
 */
export const UISP_AREA_ATTAINMENT: Record<number, Record<"A" | "B" | "C" | "D", number>> = {
  2025: { A: 214.3, B: 121.1, C: 122.2, D: 105.9 },
  2026: { A: 0, B: 0, C: 0, D: 0 },
};
...
const UISP_INDICATORS_BASE: (Omit<UispIndicatorRow, "years" | "baseline" | "target" | "actual"> & {
...
})[] = [
  {
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 1, actual: 3 },
  },
  {
    id: "A13",
    area: "A",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 1, actual: 1 },
  },
  {
    id: "A21",
    area: "A",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 20, actual: 24 },
  },
  {
    id: "A22",
    area: "A",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 100, target: 101, actual: 381 },
  },
  {
    id: "A31",
    area: "A",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 90 },
  },
  {
    id: "A32",
    area: "A",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 92.2, target: 92.5, actual: 91.2 },
  },
  {
    id: "A33",
    area: "A",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 73.3, target: 73.3, actual: 90 },
  },
  {
    id: "A34",
    area: "A",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 82.4 },
  },
  {
    id: "A35",
    area: "A",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 0 },
  },
  {
    id: "A121",
    area: "A",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 15 },
  },
  {
    id: "A122",
    area: "A",
    code: "A122",
    indicator: "기초/교양-전공-융합교육 연계 신규교과 개발 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 2 },
  },
  {
    id: "A141",
    area: "A",
    code: "A141",
    indicator: "자유전공 프로그램 운영 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 17 },
  },
  {
    id: "A142",
    area: "A",
    code: "A142",
    indicator: "자유전공 예비신입생 대상 프로그램 운영 수",
    dept: "교학실(대학)",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 1 },
  },
  {
    id: "A231",
    area: "A",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 71, target: 71, actual: 61 },
  },
  {
    id: "A232",
    area: "A",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 5, target: 6, actual: 4 },
  },
  {
    id: "A233",
    area: "A",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 1, actual: 0 },
  },
  {
    id: "B11",
    area: "B",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 20, target: 21, actual: 22 },
  },
  {
    id: "B21",
    area: "B",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 364, target: 375, actual: 400 },
  },
  {
    id: "B24",
    area: "B",
    ...
    real2025: { baseline: 0, target: 57, actual: 14 },
  },
  {
    id: "B31",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 76.4, target: 76.9, actual: 92 },
  },
  {
    id: "B32",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 95.1, target: 95.4, actual: 92.8 },
  },
  {
    id: "B34",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 84.2 },
  },
  {
    id: "B41",
    area: "B",
  ...
  },
  {
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 87.4 },
  },
  {
    id: "B121",
    area: "B",
    code: "B121",
    indicator: "맞춤형 전공・진로탐색 프로그램 운영 수(교학실)",
    dept: "교학실(대학)",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 6 },
  },
  {
    id: "B122",
    area: "B",
    code: "B122",
    indicator: "맞춤형 전공・진로탐색 프로그램 운영 수(글로컬)",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    area: "B",
    code: "B123",
    indicator: "맞춤형 전공・진로탐색 프로그램 운영 수(혁신사업단 비교과)",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    area: "B",
    code: "B131",
    indicator: "글로컬 현장 프로그램 운영 수(기존)",
    dept: "글로컬현장교육원",
    baseline: 2,
    target: 4,
    actual: 0,
    unit: "건",
    real2025: { baseline: 2, target: 3, actual: 5 },
  },
  {
    id: "B132",
    area: "B",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 4, target: 6, actual: 6 },
  },
  {
    id: "B133",
    area: "B",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 4, target: 5, actual: 5 },
  },
  {
    id: "B134",
    area: "B",
  ...
  },
  {
    ...
    area: "B",
    code: "B135",
    indicator: "글로컬 현장 프로그램 운영 수(교환학생)",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    area: "B",
    code: "B221",
    indicator: "맞춤형 전공・진로탐색 참여 학생 수(교학실)",
    dept: "교학실(대학)",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 354 },
  },
  {
    id: "B222",
    area: "B",
    code: "B222",
    indicator: "맞춤형 전공・진로탐색 참여 학생 수(글로컬)",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 4 },
  },
  {
    id: "B223",
    area: "B",
    code: "B223",
    indicator: "맞춤형 전공・진로탐색 참여 학생 수(혁신사업단 비교과)",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 11 },
  },
  {
    id: "B231",
    area: "B",
    code: "B231",
    indicator: "학생생활상담 참여 학생 수",
    dept: "학생생활상담소",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 970 },
  },
  {
    id: "B232",
    area: "B",
    code: "B232",
    indicator: "멘토링(교원) 참여 학생 수",
    dept: "교육혁신처(IR)",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 996 },
  },
  {
    id: "B233",
    area: "B",
    code: "B233",
    indicator: "멘토링(대학원생-학부생) 참여 학생 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 10 },
  },
  {
    id: "B234",
    area: "B",
    code: "B234",
    indicator: "멘토링(동문연계) 참여 학생 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 41 },
  },
  {
    id: "B235",
    area: "B",
    code: "B235",
    indicator: "멘토링(북한이탈주민재학생) 참여 학생 수",
    dept: "남북한평화신학연구소",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "명",
    real2025: { baseline: 0, target: 0, actual: 9 },
  },
  {
    id: "B251",
    area: "B",
    code: "B251",
    indicator: "글로컬 현장 참여 학생 수(기존)",
    dept: "글로컬현장교육원",
    baseline: 27,
    target: 28,
    actual: 0,
    unit: "명",
    real2025: { baseline: 27, target: 28, actual: 28 },
  },
  {
    id: "B252",
    area: "B",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 34, target: 35, actual: 47 },
  },
  {
    id: "B253",
    area: "B",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 47, target: 47, actual: 336 },
  },
  {
    id: "B254",
    area: "B",
    code: "B254",
    indicator: "사회봉사(추가) 참여 학생 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    area: "B",
    code: "B331",
    indicator: "학생생활상담 만족도 평균",
    dept: "학생생활상담소",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 0, actual: 87.2 },
  },
  {
    id: "B332",
    area: "B",
    code: "B332",
    indicator: "멘토링(북한이탈주민재학생) 만족도 평균",
    dept: "남북한평화신학연구소",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 0, actual: 0 },
  },
  {
    id: "B333",
    area: "B",
    code: "B333",
    indicator: "멘토링(대학원생-학부생) 만족도 평균",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 0, actual: 92 },
  },
  {
    id: "B334",
    area: "B",
    code: "B334",
    indicator: "멘토링(동문연계) 만족도 평균",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 0, actual: 82.8 },
  },
  {
    id: "B351",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 72.2, target: 72.7, actual: 96.2 },
  },
  {
    id: "B352",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 72.8, target: 73.3, actual: 90.8 },
  },
  {
    id: "B353",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 73, actual: 86.8 },
  },
  {
    id: "B354",
    area: "B",
    code: "B354",
    indicator: "사회봉사(추가) 만족도 평균",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 88.8 },
  },
  {
    id: "B432",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 74.2 },
  },
  {
    id: "B433",
    area: "B",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 82.8 },
  },
  {
    id: "B434",
    area: "B",
    code: "B434",
    indicator: "사회봉사(추가) 역량 향상도 평균",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 93.8, target: 93.9, actual: 94.8 },
  },
  {
    id: "C32",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 93.7, target: 93.8, actual: 91.2 },
  },
  {
    id: "C33",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 93.5, target: 93.6, actual: 94.6 },
  },
  {
    id: "C34",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 92.2, target: 92.3, actual: 91.4 },
  },
  {
    id: "C41",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 79.8, target: 79.83, actual: 82.4 },
  },
  {
    id: "C42",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 90.6, target: 90.63, actual: 87.4 },
  },
  {
    id: "C43",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 89.2 },
  },
  {
    id: "C44",
    area: "C",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 0, target: 65, actual: 87.2 },
  },
  {
    id: "C111",
    area: "C",
    ...
    real2025: { baseline: 26, target: 27, actual: 35 },
  },
  {
    id: "C112",
    area: "C",
    ...
    real2025: { baseline: 1, target: 2, actual: 4 },
  },
  {
    id: "C121",
    area: "C",
    ...
    real2025: { baseline: 89, target: 91, actual: 134 },
  },
  {
    id: "C122",
    area: "C",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 10, actual: 10 },
  },
  {
    id: "C131",
    area: "C",
    ...
    real2025: { baseline: 4, target: 5, actual: 10 },
  },
  {
    id: "C132",
    area: "C",
  ...
  },
  {
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 660, target: 670, actual: 676 },
  },
  {
    id: "C212",
    area: "C",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 63, target: 70, actual: 114 },
  },
  {
    id: "C221",
    area: "C",
    ...
    real2025: { baseline: 145, target: 152, actual: 257 },
  },
  {
    id: "C222",
    area: "C",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 56, target: 59, actual: 50 },
  },
  {
    id: "C231",
    area: "C",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 60, target: 65, actual: 61 },
  },
  {
    id: "C232",
    area: "C",
    ...
    real2025: { baseline: 155, target: 155, actual: 326 },
  },
  {
    id: "D12",
    area: "D",
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 78, target: 80, actual: 86 },
  },
  {
    id: "D21",
    area: "D",
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 581, target: 582, actual: 628 },
  },
  {
    id: "D22",
    area: "D",
  ...
  },
  {
    ...
    actual: 0,
    unit: "명",
    real2025: { baseline: 23, target: 26, actual: 30 },
  },
  {
    id: "D31",
    area: "D",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 75.1, target: 75.5, actual: 73 },
  },
  {
    id: "D32",
    area: "D",
  ...
  },
  {
    ...
    actual: 0,
    unit: "건",
    real2025: { baseline: 1, target: 1, actual: 1 },
  },
  {
    id: "D112",
    area: "D",
  ...
  },
  {
    ...
    area: "D",
    code: "D131",
    indicator: "디지털 콘텐츠(CTL) 개발 수",
    dept: "교육혁신처(CTL)",
    baseline: 0,
    target: 0,
    actual: 0,
    unit: "건",
    real2025: { baseline: 0, target: 0, actual: 33 },
  },
  {
    id: "D132",
    area: "D",
    code: "D132",
    indicator: "디지털 콘텐츠(비교과) 개발 수",
    dept: "교육혁신처",
    baseline: 0,
    target: 0,
    actual: 0,
  ...
  },
  {
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 80, target: 80.5, actual: 83.4 },
  },
  {
    id: "D332",
    area: "D",
    ...
    actual: 0,
    unit: "점",
    real2025: { baseline: 73.9, target: 74.4, actual: 72.6 },
  },
];
